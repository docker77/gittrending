              ...
              <fieldset className="w-full">
                ...
                <div className="relative">
                  <select
                    id="language"
                    name="language"
                    className="block w-full py-2 pl-3 pr-10 text-base text-white bg-gray-700 border border-transparent appearance-none bg-none rounded-md focus:outline-none focus:ring-white focus:border-white sm:text-sm"
        ...
        <div className="pt-8 border-t border-gray-700 lg:flex lg:items-center lg:justify-between xl:mt-0">
          ...
          <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full min-w-0 px-4 py-2 text-base text-gray-900 placeholder-gray-500 bg-white border border-transparent appearance-none rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white focus:border-white focus:placeholder-gray-400 sm:max-w-xs"
